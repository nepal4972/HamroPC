...
if(isset($_POST['addcategory'])){
    if(isset($_POST['category_name']) && isset($_POST['cathash_name'])) {

        $sql = 'insert into category (category_name, cathash_name) values ("' . $_POST['category_name'] . '", "' . $_POST['cathash_name'] . '")';
            ...
            <div class="col-md-12 grid-item productform">
                <div class="admin-form2">
                    ...
                    <form method="post">
                        <br>
                        Category Name:
                        <input class="form-control" type="text" name="category_name" placeholder="Product Name"><br>
                        Category Price:
                        <input class="form-control" type="text" name="cathash_name" placeholder="Category Hash Code">
                        <br><br>
                        <input class="mb-0" type="submit" name="addcategory" value="Add Category" onclick="return confirm('Are You Sure?');"> </form>
                </div>
            </div>
    </div>
    </div>
