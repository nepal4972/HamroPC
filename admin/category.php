                ...
                .more-btn a {
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        <td>
                            ...
                            <a href="categoryupdate?updatecatid=<?php echo $row['cat_id']; ?>" class="text-light">Update</a>
                            </button>
                            <button class="btn btn-danger">
                            <a href="categorydelete?deletecatid=<?php echo $row['cat_id']; ?>" class="text-light" onclick="return confirm('Want To Delete This Category?');">Delete</a>
                            </button>
                    </td>
                    </tr>
