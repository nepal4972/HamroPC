        ...
        <div id="page-content-wrapper">
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                ...
                .more-btn a {
                    ...
                    <h3 class="fs-4 mb-3">Category Lists</h3>
                    <div class="more-btn">
                        ...
                        <table class="table bg-white rounded shadow-sm  table-hover">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">Category Hash Code</th>
                    ...
                    while ($row = mysqli_fetch_assoc($result)) {
                        ...
                        echo '<td>'.$row['cathash_name'].'</td>'?>
                        <td>
                            <button class="btn btn-primary">
                            <a href="categoryupdate.php?updatecatid=<?php echo $row['cat_id']; ?>" class="text-light">Update</a>
                            </button>
                            <button class="btn btn-danger">
                            <a href="categorydelete.php?deletecatid=<?php echo $row['cat_id']; ?>" class="text-light" onclick="return confirm('Want To Delete This Category?');">Delete</a>
                            </button>
                    </td>
                    </tr>
