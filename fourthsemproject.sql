...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2022 at 08:00 PM
...
INSERT INTO `ordertable` (`InvoiceNo`, `userID`, `productID`, `productQuantity`, `orderdate`, `order_progress`) VALUES
(20, 1, 52, 3, '2022-08-03', 'Pending'),
(21, 1, 68, 1, '2022-08-03', 'Completed'),
(25, 2, 61, 1, '2022-08-05', 'Completed'),
(26, 2, 73, 1, '2022-08-05', 'Pending'),
(27, 1, 52, 2, '2022-08-05', 'Pending'),
(28, 1, 57, 2, '2022-08-05', 'Pending');
...
(52, 'COOLER MASTER COSMOS C700P WHITE', 43000, 'Item Height ?25.6 Inches : Item Width ?16.2 Inches : Product Dimensions ?64.01 x 41.15 x 65.02 cm; 22.23 Kilograms. Cooler Master Cosmos C700P Black Edition PC CaseThe Cooler Master Cosmos C700P Case featuring E-ATX, ATX, Micro-ATX, & Mini-ITX, 1 x 5.25.', 'cases', 'images/cases/Cooler Master Cosmos C700P.jpeg', 94, 'featured'),
...
(56, 'INTEL CORE I5 10400F 12M CACHE UPTO 4.3GHZ', 34200, 'Intel Core i5-10400F Processor 12M Cache, up to 4.30 GHz. Intel Core™ i5-10400F Processor 10th Generation Intel Core i5 Processors', 'processor', 'images/processor/Intel-Core-i5-10400F-10th-Generation-Desktop-Processor-Eitimad-2048x1987.jpg', 100, ''),
...
(62, 'ZOTAC GAMING GEFORCE RTX 3050 8GB', 73400, 'Built with enhanced RT Cores and Tensor Cores.\r\nNew streaming multiprocessors, and high-speed GDDR6 memory.\r\nTwin Edge 8GB GDDR6 128-bit 14 Gbps PCIE 4.0', 'gpu', 'images/gpu/rtx 3050 8gb.png', 100, 'featured'),
